...
try
{
    ...
    var invoice2 = new Invoice(1010, "Samsung Galaxy 24 ultra", new Date(2024, 6, 1), 3, 7000000);
    expenses.Add(invoice2);
    var invoice3 = new Invoice(2020, "UTP Level 6", new Date(2024, 6, 1), 100.45f, 6450);
